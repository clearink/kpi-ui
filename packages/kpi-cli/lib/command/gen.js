...
function _create() {
  _create = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(name, config) {
    var uiName, tsxTemplate, propsTemplate, uiDir, testsDir, docsDir, spinner, _name;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 10:
            ...
            (0, _fsExtra.outputFile)((0, _path.resolve)(uiDir, _constant.GEN_CONST.PROPS_FILE_NAME), propsTemplate) // props.ts
            ]);
