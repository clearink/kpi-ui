...
function compile(options) {} // 编译文件夹
...
function _compileDir() {
  _compileDir = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee() {
...
function _compileFile() {
  _compileFile = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(options) {
    var mode, entry, output, babelOptions, dirPath, dirs, _iterator, _step, dir, filePath, fileStat, entryFile, source, result, outputPath;
