import { CaretRightOutlined as svg } from '@kpi-ui/icons-svg'

// TODO: 待完善
const CaretRightOutlined = (props: any) => {
  return (
    <span className="kpi-icon">
      <svg viewBox="0 0 1024 1024" focusable="false" height="1em" width="1em">
