...
type StartAnimation = (onComplete: () => void) => () => void

export class MotionValue<V = any> {
  readonly _type = motionValueSymbol
...
export function isMotionValue(obj: any): obj is MotionValue {
  return isObject(obj) && (obj as MotionValue)._type === motionValueSymbol
}
export default function motionValue<V>(initial: V | MotionValue<V>) {
